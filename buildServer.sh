...
mkdir /home/encoder/streamline/www

# Make it writable

sudo chmod 775 /home/encoder/streamline/www
...
(crontab -l 2>/dev/null; echo "*  *  *   *  * find /home/encoder/streamline/www/*.ts -mmin +1 -print0 | xargs -0 rm -r") | crontab -
(crontab -l 2>/dev/null; echo "*  *  *   *  * find /home/encoder/streamline/www/*.m3u8 -mmin +1 -print0 | xargs -0 rm -r") | crontab -
